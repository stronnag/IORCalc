...
static edit_field_t editlist[] = {
    ...
    {"Address:", "address0", offsetof(ior_rec_t, address[0]), 28, 0, 2,
     EDIT_TYPE_ED_C},
    {"Designer:", "designer", offsetof(ior_rec_t, designer), 18, 2, 2,
     EDIT_TYPE_ED_C},
    {"Age month:", "mon", offsetof(ior_rec_t, mon), 2, 4, 2, EDIT_TYPE_ED_I},
    {"Year", "yr", offsetof(ior_rec_t, yr), 4, 6, 2, EDIT_TYPE_ED_I},
    {" :", "address1", offsetof(ior_rec_t, address[1]), 28, 0, 3,
     EDIT_TYPE_ED_C},
    {"Builder:", "builder", offsetof(ior_rec_t, builder), 18, 2, 3,
     EDIT_TYPE_ED_C},
    {"Hull month:", "hmo", offsetof(ior_rec_t, hmo), 2, 4, 3, EDIT_TYPE_ED_I},
    {"Year", "hyr", offsetof(ior_rec_t, hyr), 4, 6, 3, EDIT_TYPE_ED_I},
    {" :", "address2", offsetof(ior_rec_t, address[2]), 28, 0, 4,
     EDIT_TYPE_ED_C},
    ...
    {"Comment1:", "comment0", offsetof(ior_rec_t, comment[0]), 36, 0, 9,
     EDIT_TYPE_ED_C},
    {"Anchor1:", "anchor1", offsetof(ior_rec_t, anchor[0]), 12, 2, 9,
     EDIT_TYPE_ED_C},
    {"Ballast1:", "ballast1", offsetof(ior_rec_t, ballast[0]), 12, 4, 9,
     EDIT_TYPE_ED_C},
    {"Battery1:", "battery1", offsetof(ior_rec_t, battery[0]), 12, 6, 9,
     EDIT_TYPE_ED_C},
    {"Comment2:", "comment1", offsetof(ior_rec_t, comment[1]), 36, 0, 10,
     EDIT_TYPE_ED_C},
    {"Anchor2:", "anchor2", offsetof(ior_rec_t, anchor[1]), 12, 2, 10,
     EDIT_TYPE_ED_C},
    {"Ballast2:", "ballast2", offsetof(ior_rec_t, ballast[1]), 12, 4, 10,
     EDIT_TYPE_ED_C},
    {"Battery2:", "battery2", offsetof(ior_rec_t, battery[1]), 12, 4, 10,
     EDIT_TYPE_ED_C},
    {"Comment3:", "comment2", offsetof(ior_rec_t, comment[2]), 36, 0, 11,
     EDIT_TYPE_ED_C},
    {"Anchor2:", "anchor2", offsetof(ior_rec_t, anchor[2]), 12, 2, 11,
     EDIT_TYPE_ED_C},
    {"Ballast3:", "ballast3", offsetof(ior_rec_t, ballast[2]), 12, 4, 11,
     EDIT_TYPE_ED_C},
    {"Battery3:", "battery3", offsetof(ior_rec_t, battery[2]), 12, 4, 11,
     EDIT_TYPE_ED_C},
    {"Note: Unit Codes, 0=Imperial, 1=Metric", NULL, 0, 0, 0, 12,
     EDIT_TYPE_ED_T},
    ...
    {"CCFD  [0/n]", "idc0", offsetof(ior_rec_t, idc[0]), 1, 0, 13,
     EDIT_TYPE_ED_I},
    {"CCOMD [0/n]", "idc1", offsetof(ior_rec_t, idc[1]), 1, 2, 13,
     EDIT_TYPE_ED_I},
    {"CCMD  [0/n]", "idc2", offsetof(ior_rec_t, idc[2]), 1, 4, 13,
     EDIT_TYPE_ED_I},
    {"CCCMD [0/n]", "idc3", offsetof(ior_rec_t, idc[3]), 1, 6, 13,
     EDIT_TYPE_ED_I},
    {"CCAI  [0/n]", "idc4", offsetof(ior_rec_t, idc[4]), 1, 8, 13,
     EDIT_TYPE_ED_I},
    ...
    {"SD(1)", "pdef00", offsetof(ior_rec_t, pdef[0][0]), 8, 0, 10,
     EDIT_TYPE_ED_F},
    {"SD(2)", "pdef01", offsetof(ior_rec_t, pdef[0][1]), 8, 2, 10,
     EDIT_TYPE_ED_F},
    {"SD(3)", "pdef02", offsetof(ior_rec_t, pdef[0][2]), 8, 4, 10,
     EDIT_TYPE_ED_F},
    {"SD(4)", "pdef03", offsetof(ior_rec_t, pdef[0][3]), 8, 6, 10,
     EDIT_TYPE_ED_F},
    {"SD(5)", "pdef04", offsetof(ior_rec_t, pdef[0][4]), 8, 8, 10,
     EDIT_TYPE_ED_F},
    {"PD(1)", "pdef10", offsetof(ior_rec_t, pdef[1][0]), 8, 0, 11,
     EDIT_TYPE_ED_F},
    {"PD(2)", "pdef11", offsetof(ior_rec_t, pdef[1][1]), 8, 2, 11,
     EDIT_TYPE_ED_F},
    {"PD(3)", "pdef12", offsetof(ior_rec_t, pdef[1][2]), 8, 4, 11,
     EDIT_TYPE_ED_F},
    {"PD(4)", "pdef13", offsetof(ior_rec_t, pdef[1][3]), 8, 6, 11,
     EDIT_TYPE_ED_F},
    {"PD(5)", "pdef14", offsetof(ior_rec_t, pdef[1][4]), 8, 8, 11,
     EDIT_TYPE_ED_F},
    ...
    {"Note: Rig Factor: 0=None, 1=LRP, 2=SMF, 3=LRP & SMF", NULL, 0, 0, 0, 15,
     EDIT_TYPE_ED_T},
    {"Note: Mule code  :  0 None,  1 Mule, 2 Topsail", NULL, 0, 0, 0, 16,
     EDIT_TYPE_ED_T}};

size_t editlist_length1 = (sizeof(editlist) / sizeof(edit_field_t));

static char *attrs[] = {"yacht", "sail", "yr",  "loa",  "fgo",  "ago",  "fd",
                        "cmd",   "md",   "omd", "bmax", "b",    "bf",   "bfi",
                        "bai",   "ba",   "gd",  "y",    "vhai", "vha",  "sbmax",
                        "sdm",   "fss",  "ffs", "ffis", "ffds", "fbis", "fmds",
                        "fais",  "fas",  "dms", "ffm",  "fam",  "bwl",  "pl",
                        "p",     "e",    "bas"};
...
edit_field_t *find_field_by_name(char *name, void *u) {
    edit_field_t *r = NULL;
    if (name != NULL && u != NULL) {
...
void update_rec(char *dt, void *u, int count) {
    switch (editlist[count].flag) {
    case EDIT_TYPE_ED_C:
        set_string(dt, u, count);
        break;
    case EDIT_TYPE_ED_F:
        *(double *)(u + editlist[count].offset) = strtod(dt, NULL);
        break;
    case EDIT_TYPE_ED_I:
        *(int *)(u + editlist[count].offset) = strtol(dt, NULL, 10);
        break;
    }
}

char *get_as_string(void *u, int count) {
    char ctext[32];
    char format[8];

    switch (editlist[count].flag) {
    case EDIT_TYPE_ED_C:
        return strdup((char *)(u + editlist[count].offset));
    case EDIT_TYPE_ED_T:
        return strdup(editlist[count].prompt);
    case EDIT_TYPE_ED_F:
        sprintf(format, "%%%d.3f", editlist[count].len);
        double d = *(double *)(u + editlist[count].offset);
        sprintf(ctext, format, d);
        return strdup(ctext);
    case EDIT_TYPE_ED_I:
        sprintf(format, "%%%dd", editlist[count].len);
        sprintf(ctext, format, *(int *)(u + editlist[count].offset));
        return strdup(ctext);
    }
    return NULL; // NOTREACHED
}

int get_int(void *u, int count) { return *(int *)(u + editlist[count].offset); }

double get_double(void *u, int count) {
    return *(double *)(u + editlist[count].offset);
}

char *get_string(void *u, int count) {
    return (char *)(u + editlist[count].offset);
}

void set_int(int v, void *u, int count) {
    *(int *)(u + editlist[count].offset) = v;
}

void set_double(double d, void *u, int count) {
    *(double *)(u + editlist[count].offset) = d;
}

void set_string(char *s, void *u, int count) {
    strcpy(u + editlist[count].offset, s);
}
