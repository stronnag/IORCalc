...
static edit_field_t editlist[] = {
     ...
     {"Measurer:","measurer",offsetof(ior_rec_t,measurer), 24, 2, 1, EDIT_TYPE_ED_C},
     {"Address:","address0",offsetof(ior_rec_t,address[0]), 28, 0, 2, EDIT_TYPE_ED_C},
     {"Class:","class",offsetof(ior_rec_t,class), 18, 2, 2, EDIT_TYPE_ED_C},
     {" :","address1",offsetof(ior_rec_t,address[1]), 28, 0, 3, EDIT_TYPE_ED_C},
     {"Designer:","designer",offsetof(ior_rec_t,designer), 18, 2, 3, EDIT_TYPE_ED_C},
     {" :","address2",offsetof(ior_rec_t,address[2]), 28, 0, 4, EDIT_TYPE_ED_C},
     {"Builder:","builder",offsetof(ior_rec_t,builder), 18, 2, 4, EDIT_TYPE_ED_C},
     {"Keel:","keel",offsetof(ior_rec_t,keel), 12, 0, 6, EDIT_TYPE_ED_C},
     ...
     {"Age month:","mon",offsetof(ior_rec_t,mon), 2, 4, 8, EDIT_TYPE_ED_I},
     {"Year","yr",offsetof(ior_rec_t,yr), 4, 6, 8, EDIT_TYPE_ED_I},
     ...
     {"Ballast1:","ballast1",offsetof(ior_rec_t,ballast[0]), 12, 0, 10, EDIT_TYPE_ED_C},
     {"Ballast2:","ballast1",offsetof(ior_rec_t,ballast[1]), 12, 2, 10, EDIT_TYPE_ED_C},
     {"Ballast3:","ballast1",offsetof(ior_rec_t,ballast[2]), 12, 4, 10, EDIT_TYPE_ED_C},
     {"Battery1:","battery1",offsetof(ior_rec_t,battery[0]), 12, 0, 11, EDIT_TYPE_ED_C},
     {"Battery2:","battery2",offsetof(ior_rec_t,battery[1]), 12, 2, 11, EDIT_TYPE_ED_C},
...
int get_int(void *u, int count) {
     return *(int*)(u+editlist[count].offset);
}
